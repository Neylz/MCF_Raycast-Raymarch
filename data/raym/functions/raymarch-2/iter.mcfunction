...
function raym:raymarch-2/positionparse with storage raym:math data


## loop
scoreboard players add #step raym 1
scoreboard players operation #current_distance raym += #d raym
execute unless score #success raym matches 1 if score #step raym < .max_step raym if score #current_distance raym < .max_distance raym at @s run function raym:raymarch-2/iter
